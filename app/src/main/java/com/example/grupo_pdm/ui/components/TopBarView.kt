...
class TopBarView @JvmOverloads constructor(
    ...
    init {
        ...
        // Adiciona a view inflada como “filha” do FrameLayout
        addView(v)
        ...
        etSearch.setOnEditorActionListener { _, actionId, event ->
            ...
            // Alguns teclados disparam “actionSearch/actionDone/etc.”
            val imeAction =
            ...
            // Outros teclados disparam “enter key” (KeyEvent)
            val enterKey =
                event?.keyCode == KeyEvent.KEYCODE_ENTER &&
                        event.action == KeyEvent.ACTION_DOWN

            // Se for uma ação de pesquisa/done/go/send ou se for enter, dispara a pesquisa
            if (imeAction || enterKey) {
                triggerSearch()
                true // consumimos o evento
            } else {
                false // não consumimos o evento
            }
        }
    }
    ...
    // ============================================================
    // API pública para os Fragments configurarem o TopBar
    // ============================================================
